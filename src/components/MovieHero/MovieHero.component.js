    ...
    <div className="relative hidden lg:block shadow-inner"  style={{height: "35rem"}}>
        ...
        />
           ...
           <div className="flex flex-col items-start gap-4 z-70">
               <h1 className="text-5xl font-bold text-white">Venom: Let There Be Carnage</h1>
               <div className="flex flex-row gap-2">
               <FcLike className="w-1/6 h-1/5 text-xl"/>
               <span className="text-xl text-white font-bold">86%</span>
               <h2 className="text-gray-100 w-28">11.7K ratings</h2>
               ...
               <button className="font-semibold px-2 text-black bg-gray-50 rounded-sm">2D,3D SCREEN X,MX4D,4DX 3D</button>
               <button className="font-semibold px-2 text-black bg-gray-50 rounded-sm">English,Hindi,Tamil</button>
               </div>
               <div className="flex gap-2">
                <span className="text-white ">1h 30m •</span>
                <span className="text-white hover:underline"> Mystery,</span>
                <span className="text-white hover:underline">Sci-Fi,</span>
            ...
            <img src="https://in.bmscdn.com/iedb/movies/images/mobile/listing/xlarge/venom-let-there-be-carnage-et00122532-29-09-2021-06-14-07.jpg"
            alt="poster"
